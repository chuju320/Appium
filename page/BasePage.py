...
class AppAction(object):
    ...
    def getDesCap(self,tarApp):
        ...
        if resetKeyboard.upper() == 'TRUE':
            ...
            resetKeyboard = False
        desired_caps = [platformName,platformVersion,deviceName,app,appPackage,appActivity,udid,unicodeKeyboard,resetKeyboard]
        return desired_caps
